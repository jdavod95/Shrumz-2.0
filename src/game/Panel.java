...
//				ButtonEvents.REGENSOIL, true));
		...
		butts.add(new Button(cx+App.W-50, cy+45, 40, 40, "Del",
				ButtonEvents.BRPLNULL, true));
		
		butts.add(new Button(cx+App.W-95, cy+45, 40, 40, 2, 2,
				ButtonEvents.BRPLSHRUM, true));
		
		butts.add(new Button(cx+App.W-140, cy+45, 40, 40, 5, 2,
				ButtonEvents.BRPLBLUSHRUM, true));
		
		butts.add(new Button(cx+App.W-185, cy+45, 40, 40, 3, 4,
